...
podTemplate(
    ...
    containers: [
        ...
        containerTemplate(name: 'base-build', image: 'iguazioci/alpine-base-build:5540620c8c98efee4debfaa14e4c2a47d7110f22', workingDir: workDir, resourceRequestCpu: '4000m', resourceLimitCpu: '4000m', resourceRequestMemory: '5048Mi', resourceLimitMemory: '5048Mi', ttyEnabled: true, command: 'cat'),
    ],
    volumes: [
