Feature: Monitoring app Page
  ...
  Scenario: MLMA003 - Check monitoring-app section components on Monitoring app page
    ...
    Then "Model_Endpoint_Detections_Title" element on "Monitoring_App" should contains "Model Endpoint with detections" value
    ...
    Then "Operating_Functions_Title" element on "Monitoring_App" should contains "Operating functions" value
  ...
  Scenario: MLMA007 - Check Artifacts section components on Application monitoring page
    ...
    And wait load page
    Then "Table_Name_Filter_Input" element on "Files" should contains "monitorAppV1" attribute value
    And wait load page
  ...
  Scenario: MLMA012 - Check Endpoints list section components on Applications metrics page
    ...
    Then type value "for" to "Search_By_Endpoint_Filter_Input" field on "Application_Metrics" wizard
    And wait load page
