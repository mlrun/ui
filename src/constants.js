...
export const FETCH_DATASETS_BEGIN = 'FETCH_ARTIFACTS_BEGIN'
export const FETCH_DATASETS_FAILURE = 'FETCH_ARTIFACTS_FAILURE'
export const FETCH_DATASETS_SUCCESS = 'FETCH_ARTIFACTS_SUCCESS'
