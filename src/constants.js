...
export const MODEL_MONITORING_INFRA = 'model-monitoring-infra'
...
export const FUNCTION_BUILDING_STATE = 'building'
...
export const ENTITY_TYPE_INFRA = 'infra'
...
/*=========== PROJECT NAVIGATION =============*/
export const PROJECT_SECTION_TABS = new Set([
  MONITOR_JOBS_TAB,
