      ...
      <div className="table__body-column">
        <div className="input-row-wrapper">
          <Input
            ...
            floatingLabel
            invalid={isNameNotUnique(newRoute.name, data) || !validation.isNameValid}
            invalidText={
              isNameNotUnique(newRoute.name, data) ? 'Name already exists' : 'This field is invalid'
            }
            label="Name"
          ...
          <Input
            ...
            label="Class"
            onChange={class_name => setNewRoute(state => ({ ...state, class_name }))}
            required
            requiredText="This field is required"
            setInvalid={value =>
              setValidation(state => ({
          ...
          <Input
            ...
            label="Path"
            onChange={model_path => setNewRoute(state => ({ ...state, model_path }))}
            required
            requiredText="This field is required"
            setInvalid={value =>
              setValidation(state => ({
