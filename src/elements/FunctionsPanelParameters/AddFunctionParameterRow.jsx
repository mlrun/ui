      ...
      <div className="table__body-column">
        <div className="input-row-wrapper">
          <Input
            ...
            floatingLabel
            invalid={isNameNotUnique(newParameter.name, parameters) || !validation.isNameValid}
            invalidText={
          ...
          {newParameter.type === BOOLEAN_TYPE ? (
            ...
            <Input
              ...
              invalid={!validation.isValueValid}
              label="Value"
              onChange={value => setNewParameter(state => ({ ...state, value }))}
              setInvalid={value =>
                setValidation(state => ({
                  ...state,
                  isValueValid: value
...
AddFunctionParameterRow.propTypes = {
  ...
  newParameter: PropTypes.object.isRequired,
