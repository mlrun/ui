...
import Target from 'igz-controls/images/ic_target-with-dart.svg?react'
import CrossedTarget from 'igz-controls/images/ic_target-with-arrow-unset.svg?react'
...
const FeaturesTablePanelRow = ({
  ...
  const featureRowClassNames = classnames(
    'feature-row',
    (labelFeature === feature.feature || labelFeature === feature.originalTemplate) &&
      'selected-feature',
    labelFeature && 'selected-feature-exists'
  )
  const actionClassNames = classnames(!isEditEnabled && 'readonly')
  const actionBlockClassNames = classnames('label-actions', isEditEnabled && 'with-hover')
      ...
      <div className="feature-row__actions">
        <div className={actionBlockClassNames}>
          ...
          >
            <Target
              ...
              onClick={() => isEditEnabled && toggleLabelFeature(feature.originalTemplate)}
            />
          </Tooltip>
        ...
        >
          <Delete
            ...
            onClick={() => {
              if (isEditEnabled) {
                if (labelFeature === feature.feature || labelFeature === feature.originalTemplate) {
