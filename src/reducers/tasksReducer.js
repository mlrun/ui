...
const tasksSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(fetchBackgroundTasks.pending, defaultPendingHandler)
    builder.addCase(fetchBackgroundTasks.fulfilled, (state, { payload }) => {
      state.backgroundTasks = payload
      state.loading = false
    })
    builder.addCase(fetchBackgroundTasks.rejected, defaultRejectedHandler)
  }
})
