...
describe('CodeBlock Component', () => {
  ...
  it('calls Prism.highlight with correct arguments (JSON data)', () => {
    ...
    expect(Prism.highlight).toHaveBeenCalledWith(expectedString, 'json-grammar', 'json')
  })
  ...
  it('handles different language prop', () => {
    ...
    expect(Prism.highlight).toHaveBeenCalledWith(expectedString, 'javascript-grammar', 'javascript')
  })
})
