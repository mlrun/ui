...
import { ERROR_STATE, FUNCTION_READY_STATE } from '../constants'

export const getNuclioFuncState = func => {
  return func?.status?.state === FUNCTION_READY_STATE && !func?.spec?.disable
    ? 'Running'
