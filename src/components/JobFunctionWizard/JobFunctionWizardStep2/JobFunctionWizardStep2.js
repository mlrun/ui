...
import {
  ...
  NEW_IMAGE
  // sourceCodeInBase64
} from '../JobFunctionWizard.util'
import { trimSplit } from '../../../utils'

const JobFunctionWizardStep2 = ({ appStore, formRef, formState, mode, projectName }) => {
...
JobFunctionWizardStep2.propTypes = {
...
export default JobFunctionWizardStep2
