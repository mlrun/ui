...
import { runtimeOptions, sourceCodeInBase64 } from '../JobFunctionWizard.util'
import { getChipOptions } from '../../../utils/getChipOptions'
import { getValidationRules } from 'igz-controls/utils/validation.util'

const JobFunctionWizardStep1 = ({
  formState,
  formRef,
  functionsStore,
  isStandAlone,
