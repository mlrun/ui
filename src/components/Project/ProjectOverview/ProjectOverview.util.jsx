...
import DefineAlertsIcon from 'igz-controls/images/ic-define-alerts.svg?react'
import FeatureSetIcon from 'igz-controls/images/ic-create-featureset.svg?react'
import RegisterArtifactIcon from 'igz-controls/images/ic-register-artifact.svg?react'
import CreateJobIcon from 'igz-controls/images/ic-run-batch.svg?react'
// import DeployModelIcon from 'igz-controls/images/rocket-icon.svg?react'
import FeatureVectorIcon from 'igz-controls/images/ic-feature-vector.svg?react'
import RegisterModelIcon from 'igz-controls/images/ic-register-model.svg?react'
import RTFunctionIcon from 'igz-controls/images/ic-create-realtime-function.svg?react'
import RunWorkflowIcon from 'igz-controls/images/ic-run-workflow.svg?react'
import ServingFunctionIcon from 'igz-controls/images/ic-deploy-model-serving.svg?react'
import TrainModelIcon from 'igz-controls/images/ic-train-model.svg?react'

// import UploadIcon from 'igz-controls/images/upload-icon.svg?react'
      ...
      actions: [
        {
          ...
          handleClick: () => ({
            path: generateNuclioLink(`${base_url}/real-time-functions/new`),
            externalLink: true
          }),
          tooltip:
